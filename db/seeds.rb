...
puts "Seeding boards..."
client1_backlog = client1.boards.create(name: 'Backlog')
client1_todo = client1.boards.create(name: 'To Do')
client1_completed = client1.boards.create(name: 'Completed')

apple_backlog = client2.boards.create(name: 'Backlog')
apple_todo = client2.boards.create(name: 'To Do')
apple_completed = client2.boards.create(name: 'Completed')

client3_backlog = client3.boards.create(name: 'Backlog')
client3_todo = client3.boards.create(name: 'To Do')
client3_completed = client3.boards.create(name: 'Completed')
...
client3_completed.tasks.create(
